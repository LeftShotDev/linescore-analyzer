							...
							{onChatSizeChange && (
								<div className="flex items-center gap-1 mr-2">
									...
									<button
										...
										className={`p-1.5 rounded transition-colors ${chatSize === 'default'
									...
									<button
										...
										className={`p-1.5 rounded transition-colors ${chatSize === 'expanded'
												? 'bg-[#3ecf8e]/20 text-[#3ecf8e]'
												: 'text-[#888] hover:text-white hover:bg-[#2e2e2e]'
											}`}
										title="Expand"
									...
									<button
										...
										className={`p-1.5 rounded transition-colors ${chatSize === 'maximized'
												? 'bg-[#3ecf8e]/20 text-[#3ecf8e]'
												: 'text-[#888] hover:text-white hover:bg-[#2e2e2e]'
											}`}
										title="Maximize"
